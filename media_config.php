...
function getTimelineConfig($year = null) {
    ...
    $defaultTimeline = [
        '2022' => [
            'title' => '用心料理，温暖人心 ✨',
            'description1' => 'Tokyo Japanese Cuisine 于 2022 年在 JB Southkey Mid Valley 开出首家分店。自创立之初，我们便以匠心料理与真诚服务为本，希望让每一位走进 Tokyo Japanese Cuisine 的顾客，都能感受到家的温馨，收获一段愉悦而难忘的用餐体验',
