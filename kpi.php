    ...
    document.querySelectorAll('.informationmenu-section-title').forEach(title => {
        ...
        <script>
            ...
            function selectLetter(letter) {
                ...
                // 更新按钮显示但不切换餐厅
                document.querySelector('.restaurant-btn').innerHTML = `${letter}-- <i class="fas fa-chevron-down"></i>`;
            }
            ...
            function updateRestaurantButton() {
                ...
                if (currentNumber === 'total') {
                    restaurantBtn.innerHTML = `${currentLetter}总 <i class="fas fa-chevron-down"></i>`;
