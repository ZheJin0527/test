        ...
        <nav class="nav-links" id="navMenu">
            ...
            <div class="nav-item nav-dropdown">
                ...
                <div class="nav-dropdown-menu" id="brandsNavDropdownMenu">
                    <a href="tokyo-japanese-cuisine.html" class="nav-dropdown-item">Tokyo Japanese Cuisine</a>
                    <a href="tokyo-izakaya.html" class="nav-dropdown-item">Tokyo Izakaya Japanese Cuisine</a>
                </div>
            </div>
        ...
        <div class="right-section">
            ...
            <div class="login-dropdown">
                ...
                <div class="login-dropdown-menu" id="loginDropdownMenu">
                    <a href="login.html" class="login-dropdown-item">Staff Login</a>
                    <a href="login.html" class="login-dropdown-item">Member Login</a>
                </div>
            </div>

            <!-- 翻译按钮始终显示 -->
            <div class="language-switch">
                <button class="lang" id="languageBtn">English</button>
