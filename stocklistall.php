    ...
    <script>
        ...
        async function checkLowStock() {
            try {
                ...
                const minStockSettings = result.data || {};
                const lowStockItems = [];
            ...
            lowStockItems.forEach(item => {
                itemsList += `
                    <tr style="background-color: #fef2f2;">
                        ...
                        <td style="color: #dc2626; font-weight: 600;">${item.formatted_stock}</td>
                        <td style="color: #059669; font-weight: 600;">${item.minStock}</td>
                        <td style="color: #dc2626; font-weight: 600;">${item.shortage.toFixed(2)}</td>
                ...
                <div class="modal-content" style="max-width: 900px;">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-error" style="margin-bottom: 20px;">
                            ...
                            <span>发现 <strong>${lowStockItems.length}</strong> 个产品库存不足，请及时补货！</span>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-warning" onclick="window.open('stockeditall.php', '_blank')">
