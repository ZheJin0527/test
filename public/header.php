        ...
        <nav class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex-shrink-0">
                    <a href="index.php" class="text-white text-xl font-bold hover:text-gray-300 transition-colors">
                        <img src="../images/images/KUNZZ.png" alt="Logo" class="h-10 w-auto">
                    </a>
                </div>

                <!-- Desktop Navigation -->
                <div class="hidden lg:flex items-center space-x-8">
                    <a href="index.php" class="text-white hover:text-gray-300 transition-colors">首页</a>
                    <a href="about.php" class="text-white hover:text-gray-300 transition-colors">关于我们</a>
                    <a href="#" class="text-white hover:text-gray-300 transition-colors">旗下品牌</a>
                    <a href="joinus.php" class="text-white hover:text-gray-300 transition-colors">加入我们</a>
                </div>
                ...
                <div class="hidden lg:flex items-center space-x-4">
                    ...
                    <div class="relative login-dropdown">
                        <button class="bg-[#ff5c00] hover:bg-[#f7931e] text-white transition-colors px-6 py-2 rounded-[30px] flex items-center space-x-2">
                            <span>登入</span>
                        ...
                        <div class="absolute right-0 mt-2 w-40 bg-white rounded shadow-lg opacity-0 invisible transition-all duration-200 login-menu">
                            <a href="login.html" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">员工登入</a>
                            <a href="login.html" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">会员登入</a>
                        </div>
                    </div>

                    <!-- Language Dropdown -->
                    <div class="relative language-dropdown">
                        <button class="border-2 border-[#ff5c00] text-white hover:bg-[#ff5c00] transition-colors px-6 py-2 rounded-[30px] flex items-center space-x-2">
                            <span class="language-text">中文</span>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div class="absolute right-0 mt-2 w-32 bg-white rounded shadow-lg opacity-0 invisible transition-all duration-200 language-menu">
                            <button class="block w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-100 language-option" data-lang="中文">中文</button>
                            <button class="block w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-100 language-option" data-lang="English">English</button>
                        </div>
                    </div>
                </div>
