            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden lg:flex items-center space-x-4">
                    ...
                    <div class="relative login-dropdown">
                        <button class="border-2 border-[#ff5c00] hover:border-[#f7931e] bg-[#ff5c00] hover:bg-[#f7931e] text-white transition-colors px-6 py-2 rounded-[30px] flex items-center space-x-2">
                            <span>登入</span>
